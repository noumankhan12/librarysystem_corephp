...
<body>
	...
	<section class="section-container">
		<h2 class="section-header">Change Profile Picture</h2>
				...
				if ($msg=="SUP") {
					...
					if ($msg=="UPS") {
					echo "<p> <strong> SUCCESSFULLY UPDATED PROFILE PHOTO</strong> </p>";
			}
				...
				<form class="my-form" action="profile-picture-action.php" method="post" enctype="multipart/form-data">
			<div>
				<label for="lid01"><b>New</b></label>
				<input type="file" id="lid01" name="userfile"required />
			</div>
			<br>
			<div>
